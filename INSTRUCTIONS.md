...
This tutorial has been adapted from a masterclass created by Max Bonomi and Samuel Hoff.
...
- Perform single-structure refinement using cryo-EM maps and MD simulations.
- Perform ensemble refinement using cryo-EM maps and MD simulations.
...
# Exercise 1: single-structure refinement with EMMIVox
